...
const airPodsFeatures = [
  {
    ...
    css: "width: 274px;height: 338px;@media (min-width:1020px){width: 343px;height: 376px;transform: translateY(-40px)}",
    content: (
      <InsideMessage>
  ...
  },
  {
    ...
    css: "width: 168px;height: 339px;@media (min-width:1020px){width: 211px;height: 375px;transform: translateY(-40px)}",
    content: (
      <InsideMessage>
  ...
  },
  {
    ...
    css: "width: 223px;height: 297px;@media (min-width:1020px){width: 265px;height: 352px;}",
    content: (
      <InsideMessage>
  ...
  },
  {
    ...
    css: "width: 287px;height: 86px;@media (min-width:1020px){width: 336px;height: 100px;}",
    content: (
      <InsideMessage>
  ...
  },
  {
    ...
    description: "siri",
    css: "width: 126px;height: 126px;@media (min-width:1020px){width: 168px;height: 168px;}",
    content: (
      <InsideMessage>
  ...
  },
  {
    ...
    css: "width: 96px;height: 96px;@media (min-width:1020px){width: 135px;height: 135px;}",
    content: (
      <InsideMessage>
